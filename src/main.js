...
function createHtml() {
	...
	document.write("						<input type=\"checkbox\" id=\"areasLayerCheckbox\"> Polygons");
	document.write("						layer<br>");
	document.write("						<input type=\"checkbox\" id=\"pointsLayerCheckbox\"> Points");
	document.write("						layer<br>");
	document.write("						<input type=\"checkbox\" id=\"labelsLayerCheckbox\"> Labels");
	document.write("						layer<br>");
	document.write("						<input type=\"checkbox\" id=\"linesLayerCheckbox\"> Lines");
	document.write("						layer<br>");
	document.write("");
	document.write("					<\/div>");
	document.write("				<\/div>");
	...
	document.write("                <!-- END: panel-->");
	document.write("");
	document.write("<!-- TODO: to be fixed-->");
	document.write("				<div class=\"panel\">");
